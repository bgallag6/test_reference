# -*- coding: utf-8 -*-
"""
Created on Tue Sep 11 10:16:22 2018
...
def onclick(event):
    ...
    if ixx > 1. and iyy > 1.:
        ...
        try:                                 
            ...
            # change method to 'dogbox' and increase max number of function evaluations to 3000
            nlfit_gp, nlpcov_gp = scipy.optimize.curve_fit(Gauss, f2, s2, bounds=(M2_low, M2_high), sigma=ds2, method='dogbox', max_nfev=3000)
        ...
        try:
            ...
            nlfit_gp2, nlpcov_gp2 = scipy.optimize.curve_fit(Gauss, f2, s2, p0 = [P2, fp2, fw2], bounds=(M2_low, M2_high), sigma=ds2, max_nfev=3000)    
