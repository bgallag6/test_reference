# -*- coding: utf-8 -*-
"""
Created on Fri Jul 13 17:08:06 2018
...
pixmed0 = cube[:,y,x] / exposure  # extract timeseries + normalize by exposure time   

"""
### normalization here ###
"""  
pixmed = (pixmed0 - np.average(pixmed0)) / np.average(pixmed0)
#pixmed = pixmed0
...
#for i in [0]:
  ...
  #powers = powers**2   # normalize the power
...
#ax1.set_title('Normalized Timeseries', y=1.01, fontsize=font_size)
ax1.set_title('Raw Timeseries', y=1.01, fontsize=font_size)
plt.plot(t_interp/60, v_interp)
#ax1.set_ylabel('Normalized Intensity', fontsize=font_size-2)
ax1.set_ylabel('Raw Intensity', fontsize=font_size-2)
...
plt.xlim(10**-5, 10**-1)
plt.ylim(10**-5.5, 10**0.5)
#plt.ylim(10**1.5, 10**7.5)  # squared powers only
#plt.ylim(10**-2.5, 10**3.5)  # squared powers plus normalize timeseries
ax2.set_ylabel('Power', fontsize=font_size-2)
ax2.set_xlabel('Frequency [Hz]', fontsize=font_size-2)
#plt.savefig('C:/Users/Brendan/Desktop/normalized_timeseries.pdf', format='pdf', bbox_inches='tight')
#plt.savefig('C:/Users/Brendan/Desktop/raw_timeseries.pdf', format='pdf', bbox_inches='tight')
#"""
