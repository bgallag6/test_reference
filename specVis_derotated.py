# -*- coding: utf-8 -*-
"""
Created on Mon Jul 30 10:11:02 2018

@author: Brendan
"""

"""
* specVis tool that does everything from derotated file, no spectra file needed
"""
    ...
    if ixx > 1. and iyy > 1.:
        ...
        for m0 in [-1,0,1]:
            for n0 in [-1,0,1]:
                ...
                x = ix + n0 + 1  #offset for 171
                #y = iy + m0 + 6  #offset for 171
                y = iy + m0 + 3  #offset for 1700
        ...
        ax2.text(0.011, 10**-1.5, r'$\chi_r^2$ = {0:0.1f}'.format(redchisqrM22), fontsize=font_size-2)
...
global f_fit
#f_fit = np.linspace(freqs[0],freqs[len(freqs)-1],149)   
f_fit = freqs
